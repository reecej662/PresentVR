...
#define ORIGINAL_FILE_NAME "UE4Editor-SeniorDesignV1.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME SeniorDesignV1
#define DEPRECATED_FORGAME DEPRECATED
#define SENIORDESIGNV1_API DLLEXPORT
